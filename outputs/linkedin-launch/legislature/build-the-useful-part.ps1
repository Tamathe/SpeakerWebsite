...
drawtext=fontfile='$fontBold':text='The work continued.':fontcolor=white:fontsize=68:x=48:y=156,
...
drawtext=fontfile='$fontRegular':text='A contract with Kentucky CHFS':fontcolor=white:fontsize=40:x=82:y=496,
drawtext=fontfile='$fontRegular':text='is now in place.':fontcolor=white:fontsize=40:x=82:y=550,
drawtext=fontfile='$fontBold':text='KY-AHEAD':fontcolor=white:fontsize=30:x=82:y=704,
drawtext=fontfile='$fontRegular':text='UNIVERSITY OF KENTUCKY  +  KENTUCKY CHFS':fontcolor=white@0.68:fontsize=22:x=82:y=752,
